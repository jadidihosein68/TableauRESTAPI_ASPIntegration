...
The project aim is to provide a simple integration between Tableau Rest API and asp.net mvc 5 framework.
This repo does not cover trusted authentication integration such as OpenID or SAML.
Tabluea API use for automation only, **you can not use the API token for the VIZ**, if you want to use SSI for VIZ you have to study [Trusted Auth](http://onlinehelp.tableau.com/current/server/en-us/trusted_auth.htm)
